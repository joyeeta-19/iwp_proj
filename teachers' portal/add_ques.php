...
if(isset($_POST['add'])) {
    ...
    $marks=$_POST['marks'];
    $sql = "INSERT INTO exam_questions (examid,question,choice1,choice2,choice3,choice4,correct_choice,marks) VALUES ('$exam_nm','$ques', '$ch1','$ch2','$ch3','$ch4','$correct','$marks')";
...
<?php
$res=mysqli_query($conn,"Select * from exam_questions where examid='$exam_nm'");
