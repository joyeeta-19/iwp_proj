...
<?php
$res=mysqli_query($conn,"Select * from teachers where tch_email='$tid'");
while($row=mysqli_fetch_array($res)){
    $course1= $row['tch_course1'];
    $course2=$row['tch_course2'];
    $course3=$row['tch_course3'];
}
$result=mysqli_query($conn,"Select * from courses where tch_email='$tid'");
while($row=mysqli_fetch_array($res)){
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="content">
            <div class="card-img">
                <img src="img/c2.jpg" alt="Lights"><br>
            </div>
            <div class="card-title">
                <h2><a href="course2.html"> <?php echo $course2?></a></h2>
            </div><hr>
            <div class="card-body">
                <table width="100%">
                    <tr>
    ...
    <div class="col-md-4">
        <div class="content">
            <div class="card-img">
                <img src="img/c3.jpg" alt="Lights"><br>
            </div>
            <div class="card-title">
                <h2><a href="course2.html"> <?php echo $course3?></a></h2>
            </div><hr>
            <div class="card-body">
                <table width="100%">
                    <tr>
