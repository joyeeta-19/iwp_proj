...
<head>
    ...
    <style>
        ...
        thead{
            ...
            width: 24px;
            font-size: 24px;
            border-bottom: #f9ac3a 8px solid;
        }
        td{
            padding: 8px;
            width: 20px;
            font-size: 18px;
            border-bottom: #f9ac3a 4px solid;
        }
        table{
...
<?php
$res=mysqli_query($conn,"SELECT s.st_regno,s.st_name,s.st_mail, a.courses from student s Left Join academics a on s.st_regno = a.st_id where a.teacher_id='$tid'");
